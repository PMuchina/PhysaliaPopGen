...
```{bash}
#| eval: false
OUTPUT_PATH=/home/ubuntu/Workshops_TL_YB_PopGenResults/ ###Edit this to point toward where you would like the results to be stored. You can of course directly replace by "Results/" directly in the code. This is mostly to give you an idea of what can be done with variable declation.
...
mkdir ${OUTPUT_PATH} ###To create the folder.
...
##For next step:
cp -r ../Share/Day2_popstructure/treemix-1.13/ .
...
result_opt=optM(folder = "./Results/Bootstrap_TreeMix/")
